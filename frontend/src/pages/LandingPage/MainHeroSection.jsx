...
export function MainHeroSection() {
  return (
    <section className="relative w-full min-h-[600px] flex items-center overflow-hidden text-white">
      ...
      <div className="mx-auto max-w-7xl w-full ms-24 px-6 py-20 flex items-center justify-between gap-12">
        <div className="flex-1 max-w-xl">
          ...
          <div className="mt-8 bg-white rounded-lg shadow-xl p-6 text-gray-800">
            ...
            <div className="mt-2 flex gap-3">
              ...
              <button className="bg-[#0f2b4d] text-white px-6 py-2 rounded-md font-medium hover:opacity-90">
                Track
              </button>
            </div>
