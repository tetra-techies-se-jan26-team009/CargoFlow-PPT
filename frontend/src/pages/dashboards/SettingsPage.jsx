...
export default function SettingsPage() {
  ...
  const [profile, setProfile] = useState({ name:"Admin", email:"admin@v1logistics.com", phone:"+91 98765 00001", company:"V1 Logistics Pvt. Ltd.", timezone:"Asia/Kolkata" });
            ...
            {activeTab === "profile" && (
              <div>
                ...
                <div style={{ display:"flex", alignItems:"center", gap:16, padding:"16px 0", borderBottom:"1px solid #F1F5F9", marginBottom:8 }}>
                  <div style={{ width:60, height:60, borderRadius:"50%", background:"#EFF6FF", display:"flex", alignItems:"center", justifyContent:"center", fontSize:24, fontWeight:800, color:"#2563EB" }}>A</div>
                  <div>
                    <button style={{ padding:"7px 14px", border:"1px solid #E2E8F0", borderRadius:7, background:"white", color:"#334155", fontSize:12, fontWeight:500, cursor:"pointer", marginRight:8 }}>Change Photo</button>
                    <button style={{ padding:"7px 14px", border:"1px solid #FCA5A5", borderRadius:7, background:"white", color:"#EF4444", fontSize:12, fontWeight:500, cursor:"pointer" }}>Remove</button>
                  </div>
                </div>
                {[
                ...
                <div style={{ marginTop:20 }}>
                  <button style={{ display:"flex", alignItems:"center", gap:6, padding:"9px 20px", border:"none", borderRadius:8, background:"#2563EB", color:"white", fontSize:13, fontWeight:600, cursor:"pointer" }}>
                    <Icon d={icons.save} size={14} stroke="white"/> Save Changes
                  </button>
                </div>
              </div>
            )}
