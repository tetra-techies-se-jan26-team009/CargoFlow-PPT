      ...
      <div className="p-6 pt-0">
        ...
        >
          <span className="mr-2 inline-block">
            <img src="https://imgs.search.brave.com/6YqBXTeDGkxkHGXxUkaUuwu0LeaT4zPYOhlrOyLc2Zw/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9pbWcu/aWNvbnM4LmNvbS9j/b2xvci8xMjAwL2dv/b2dsZS1sb2dvLmpw/Zw" alt="Google Photo"
            className="h-5 w-5" />
          </span>
          Sign in with Google
        </button>
