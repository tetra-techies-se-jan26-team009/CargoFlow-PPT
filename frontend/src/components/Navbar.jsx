        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <div className="relative group">
              ...
              {/* Search Dropdown */}
              {showSearch && (
                <div className="absolute top-full right-0 mt-2 p-4 bg-white shadow-xl rounded-2xl border border-gray-200 w-72">
                  <div className="flex gap-2">
                    <input
                      className="flex-1 text-sm p-2 border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-blue-600"
                      placeholder="Enter Tracking ID..."
                      value={navTrackId}
                      onChange={(e) => setNavTrackId(e.target.value)}
                      onKeyDown={handleNavTrack}
                    />
                    <button
                      onClick={handleNavTrack}
