...
const IC = {
    ...
    business: "M3 21h18 M5 21V7a2 2 0 012-2h10a2 2 0 012 2v14 M9 9h6 M9 13h6 M9 17h6",
};
        ...
        <Modal onClose={onClose} width={420}>
            ...
            <div style={{ padding: "32px 28px", fontFamily: "'DM Sans', sans-serif", background: "#FFFFFF", borderRadius: 16 }}>
                <div style={{ textAlign: "center", marginBottom: 24 }}>
                    ...
                    <div style={{ fontSize: 20, fontWeight: 800, color: "#111827", marginBottom: 6, letterSpacing: "-0.3px" }}>Client Added!</div>
                    <div style={{ fontSize: 13, color: "#6B7280" }}>Business account successfully registered</div>
                </div>
                ...
                <div style={{ background: "#F9FAFB", border: "1px solid #E5E7EB", borderRadius: 12, overflow: "hidden", marginBottom: 24 }}>
                    <div style={{ padding: "16px 20px", display: "grid", gridTemplateColumns: "1fr", gap: "12px" }}>
                        <div>
                            <div style={{ fontSize: 10, color: "#6B7280", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.8px", marginBottom: 4 }}>Client / Business</div>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
                            ...
                            <div>
                                <div style={{ fontSize: 10, color: "#6B7280", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.8px", marginBottom: 4 }}>Location</div>
            ...
            <div style={{ background: "#FFFFFF", borderRadius: 16, overflow: "hidden", display: "flex", flexDirection: "column" }}>
                ...
                <div style={{ padding: "24px 28px 20px", background: "#F9FAFB", borderBottom: "1px solid #E5E7EB", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                        ...
                        <div>
                            <div style={{ fontSize: 18, fontWeight: 800, color: "#111827", letterSpacing: "-0.3px", marginBottom: 2 }}>Add New Client</div>
                            <div style={{ fontSize: 11, color: "#6B7280", fontFamily: "'DM Mono', monospace", letterSpacing: "0.5px" }}>REGISTER BUSINESS ACCOUNT</div>
                        </div>
                    </div>
                ...
                <div style={{ padding: "24px 28px", display: "flex", flexDirection: "column", gap: 20 }}>
                    ...
                    <F label="Business / Owner Name" icon={IC.user} required error={errs.name}>
                        <input className="asf-in" value={f.name} onChange={e => set("name", e.target.value)}
                            placeholder="e.g. Apex Traders" style={iBase(errs.name)} onFocus={oF} onBlur={oB} />
                    </F>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                        <F label="Email Address" icon={IC.mail} required error={errs.email}>
                            <input className="asf-in" type="email" value={f.email} onChange={e => set("email", e.target.value)}
                                placeholder="client@company.com" style={iBase(errs.email)} onFocus={oF} onBlur={oB} />
                        </F>
                        <F label="Phone Number" icon={IC.phone} required error={errs.phone}>
                            <input className="asf-in" type="number" value={f.phone} onChange={e => set("phone", e.target.value)}
                                placeholder="+91 98765 43210" maxLength={10} style={iBase(errs.phone)} onFocus={oF} onBlur={oB} />
                        </F>
                    </div>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                        <F label="City" icon={IC.pin} required error={errs.city}>
                            <input className="asf-in" value={f.city} onChange={e => set("city", e.target.value)}
                                placeholder="e.g. Mumbai" style={iBase(errs.city)} onFocus={oF} onBlur={oB} />
                        </F>
                        <F label="Initial Password" icon={IC.lock} required error={errs.password} hint="Temporary login access">
